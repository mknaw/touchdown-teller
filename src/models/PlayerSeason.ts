...
export const annualizePlayerProjection = (
  ...
  ...projection?.pass && { pass: annualizePassSeason(projection.pass, projection.base.gp) },
  ...projection?.recv && { recv: annualizeRecvSeason(projection.recv, projection.base.gp) },
  ...projection?.rush && { rush: annualizeRushSeason(projection.rush, projection.base.gp) },
});
